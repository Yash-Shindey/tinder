...
class LocationConfig:
    def __init__(self, city: str, country: str):
        ...
        self._geolocator = Nominatim(user_agent="tinderbotz")
    
    def get_coordinates(self) -> Tuple[float, float]:
        """Get latitude and longitude for the configured location"""
        try:
            location = self._geolocator.geocode(f"{self.city}, {self.country}")
            if location:
...
DEFAULT_LOCATION = LocationConfig("New York", "USA")
